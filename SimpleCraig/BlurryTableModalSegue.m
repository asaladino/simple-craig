...
- (void)perform
{
    ...
    UITableViewController* destination = (UITableViewController*)[navController topViewController];
    ...
    CGRect frame;
    switch (navController.modalTransitionStyle) {
    ...
    destination.tableView.backgroundView = backgroundImageView;
